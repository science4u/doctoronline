                    ...
                    <div class="col-md-9 single-content">
                        <article class="post">
                            <div class="single-thumb">
                                <img src="images/news_cirurgy.jpg" alt="#" title="<?printf ($row[$num_rows-2][1]); // titulo?>" class="img-responsive">
                            </div>
                                ...
                                <p>
                                 <h3>  
                                     <?php 
                                            ...
                                            printf ($row[$num_rows-2][2]); //conteudo1
                                        ?>
                                   </h3>
                                </p>
